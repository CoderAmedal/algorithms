...
while i >= 1 and j >= 1:
    ...
    if string1[i - 1] == string2[j - 1]:
        ...
        final_string = string1[i - 1] + final_string
        i -= 1
        j -= 1
...
# logger {
logger.println("Longest Common Subsequence Length is {}".format(A[m][n]))
logger.println("Longest Common Subsequence is {}".format(final_string))
# }
